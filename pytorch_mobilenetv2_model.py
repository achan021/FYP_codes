...
def load_dataset():
    ...
    # train_covid_label_1 = pd.read_csv('./covid_df_70_metadata.csv')
    # train_covid_label_0 = pd.read_csv('./nocovid_df_70_metadata.csv')
    # test_covid_label_1 = pd.read_csv('./covid_df_30_metadata.csv')
    # test_covid_label_0 = pd.read_csv('./nocovid_df_30_metadata.csv')
